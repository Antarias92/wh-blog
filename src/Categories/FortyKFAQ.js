        ...
        <div className="row">
            ...
            <div className="col-9">
               <div className="postContent">
                    <h4 className="question">If led by a Lord on Juggernaut in the Daemonkin detachment, will Bloodcrushers gain access to the Blessings of Khorne? </h4>
               ...
               <div className="postContent">
                    <h4 className="question">If I am using the Auric Champions Detachment, when selecting an enemy unit for the Assemblage of Might detachment rule, can I select a unit that is embarked within a transport? </h4>
                    <p className="answer">No, you cannot target units within a transport with any abilities or rules.</p>
                    <p className="category">Category: 40000faq</p>
                    <p className="category">Posted By: Admin</p>
               </div>
               <div className="postContent">
                    <h4 className="question">Can I use the Monolith’s Eternity gate ability in the first battle round to reposition a unit that is on the battlefield? </h4>
